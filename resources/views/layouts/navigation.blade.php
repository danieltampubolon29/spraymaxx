        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="Auth::user()->role == 'admin' ? route('admin.dashboard') : route('dashboard')" :active="Auth::user()->role == 'admin'
                    ...
                    <x-nav-link href="admin/booking" :active="request()->routeIs('admin.booking')">
                        {{ __('All Bookings') }}
                    </x-nav-link>
                    ...
                    <x-nav-link href="booking" :active="request()->routeIs('user.booking')">
                        {{ __('Booking') }}
                    </x-nav-link>
